...
#define MATERIAL_WATER (1029)
bool materialIsWater(int id) {
  return id == 1029;
}

#define MATERIAL_ICE (1028)
...
Sway materialSwayType(int id) {
  if (id == 1026) return Sway_UPPER;
  if (id == 1006 || id == 1025) return Sway_LOWER;
  if (id == 1018 || id == 1023 || id == 1024) return Sway_HANGING;
  if (id == 1005) return Sway_FLOATING;
  if (id == 1022) return Sway_FULL;
  return Sway_NONE;
}

#define MATERIAL_TINTED_GLASS (1021)
